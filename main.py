...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu_ids",default='0',type=str,help='The gpu_ids: e.g. 0  0,1,2  0,2')
    ...
    parser.add_argument("--Milestones", type=str, default="50,140,180", help="Learning rate decay milestone")
